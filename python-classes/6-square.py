...
getter/setter, area calculation, and printing with '#' character.
"""
...
class Square:
    ...
    def my_print(self):
        """Print the square with the '#' character in stdout, respecting position."""
        if self.__size == 0:
            print()
            return
        ...
        # print rows of square with horizontal offset
